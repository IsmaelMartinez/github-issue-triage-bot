...
This directory records significant architecture decisions for the GitHub Issue Triage Bot.

| ADR | Title | Status |
|-----|-------|--------|
| [001](001-standalone-go-service.md) | Standalone Go Service for Issue Triage | Implemented |
| [002](002-gemini-llm-provider.md) | Gemini 2.5 Flash as LLM Provider | Implemented |
